...
from .const import DOMAIN as EXTRAS_DOMAIN
...
async def async_setup_entry(hass, entry, async_add_entities):
    ...
    player = MediaBrowserExtrasMediaPlayer(hass, name)
...
class MediaBrowserExtrasMediaPlayer(MediaPlayerEntity):
    ...
    async def async_browse_media(self, media_content_type=None, media_content_id=None):
        ...
        #entities = self.hass.data[DOMAIN]
        ...
        #    return await menu_payload(self.hass, self.name)
    ...
    async def async_play_media(self, media_type, media_id, **kwargs):
        ...
        entities = self.hass.data[EXTRAS_DOMAIN]
        data = entities[self.name]
        print(entities)
        print(data)
        configdir = Path(__file__).resolve().parent.parent.parent
        p  = configdir / "mediabrowserextras"
